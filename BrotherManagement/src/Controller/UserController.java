...
public class UserController {
    private boolean validateForm(String email, String username, String password, boolean isSignup) {
    ...
    public User login(User user) {
        ...
        try (Connection con = brotherconnection.getConnection();
            ...
            if (rs.next()) {
                ...
                // tạo user đầy đủ thông tin từ database
                User loggedUser = new User();
                loggedUser.setEmail(rs.getString("email"));
                loggedUser.setFullname(rs.getString("username"));
